...
impl<A: Authorization, V, Pr: OrchardPrimitives> Bundle<A, V, Pr> {
    ...
    /// either carries no proof or carries a proof that is already known to be canonical.
    ...
    pub fn from_parts(
        ...
        Self::from_parts_unchecked(actions, flags, value_balance, burn, anchor, authorization)
    }
...
impl<V, Pr: OrchardPrimitives> Bundle<Authorized, V, Pr> {
    ...
    /// can never hold a non-canonical proof.
